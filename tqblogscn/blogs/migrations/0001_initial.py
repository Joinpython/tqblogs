    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_id', models.SmallIntegerField(choices=[(1, 'python'), (2, 'html和css'), (3, 'javascript'), (4, 'mysql'), (5, 'redis'), (6, '爬虫'), (7, 'django'), (8, 'tornado'), (9, 'linux'), (10, 'go'), (11, '贤文杂谈')], default=1, verbose_name='id')),
                ('type', models.CharField(default='python', max_length=40, verbose_name='博文类型')),
