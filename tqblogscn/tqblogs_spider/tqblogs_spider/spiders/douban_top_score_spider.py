...
class TopScoreSpider(scrapy.Spider):
    name = 'douban_top_score_spider'
    allowed_domains = ['movie.douban.com']
    start_urls = ['https://movie.douban.com/j/search_subjects?type=movie&tag=%E7%83%AD%E9%97%A8&sort=rank&page_limit=20&page_start=0']
    ...
    def parse(self, response):
        ...
        for item in data['subjects']:
            ...
            yield scrapy.Request(url=url, callback=self.parse_abstarct, meta={'meta':url})

    def parse_abstarct(self, response):
